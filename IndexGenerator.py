...
print mess
title = raw_input("Ingresa el titulo de la pagina: ")
heading = raw_input("Inserta el heading (Titulo principal) : ")
imagelink = raw_input("Inserta el URL de la imagen central (Logo): ")
...
youtubeid = raw_input("Inserta la ID del Video de youtube (Opcional): ")
